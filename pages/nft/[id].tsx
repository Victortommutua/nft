    ...
    <div className='flex h-screen flex-col lg:grid lg:grid-cols-10'>
      ...
      lg:col-span-4'>
          ...
          lg:min-h-screen'>
              ...
              <div className='text-center p-5 space-y-2'>
                  <h1 className='text-4xl font-bold text-white'>SIRVIC Apes</h1>
                  <h2
                  className='text-xl text-gray-300'
                  >A collection of SIRVIC Apes who live & breathe React</h2>
              </div>
          </div>
      </div>
      {/* right */}
      <div className='flex flex-1 flex-col p-12 lg:col-span-6'>
          ...
          space-y-6 text-center lg:space-y-0 lg:justify-center'>
              ...
              lg:font-extrabold'>The SIRVIC Ape Coding Club | NFT Drop
              </h1>
              <p className='pt-2 text-xl text-green-500'>13 / 21 NFT's claimed</p>
          </div>

          {/* mint btn */}
          <button className='mt-10 h-16 bg-red text-white 
          w-full rounded-full bg-red-600 font-bold '>
              Mint NFT (0.01 ETH)
          </button>
      </div>
    </div>
